<?php 
$URLROOT = dirname(dirname(__FILE__));
include_once $URLROOT.'/includes/head.php' ?>
<!-- Layout wrapper -->
<div class="layout-wrapper layout-content-navbar  ">
    <div class="layout-container">
      <!-- Menu -->
      <?php include_once $URLROOT.'/includes/aside.php'?>
      <!-- / Menu -->
      <!-- Layout container -->
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <!-- / Content -->
          <?php include_once $URLROOT.'/includes/footer.php' ?>
...
<!-- / Layout wrapper -->
<?php include_once $URLROOT.'/includes/tail.php' ?>
