                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-label-danger rounded-pill text-uppercase">Bitbank</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-label-warning rounded-pill text-uppercase">Payers</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-label-info rounded-pill text-uppercase">Brandi</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex justify-content-start align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="mb-0 text-truncate">Allan kristian</h6><small
                                                        class="text-truncate text-muted">Frontend Designer</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td><span class="badge bg-label-success rounded-pill text-uppercase">Crypter</span>
                                        </td>
