...
<div class="dash-main">
    ...
    <div class="dash-main__content">
        <div class="page-heading d-flex justify-content-between align-items-center">
            ...
            <div class="page-actions">
                <div class="d-inline-block dropdown">
                    <button type="button" class="btn-shadow btn bg-primary text-white" data-bs-toggle="modal" data-bs-target="#updatePersonalInformationModal">
                        <i class="fas fa-user-edit text-white" aria-hidden="true"></i>
                    </button>
                    <button type="button" class="btn-shadow btn bg-primary text-white" data-bs-toggle="modal" data-bs-target="#addSocialMediaModal">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 rounded-0">
                    <ul class="list-group break-word">
                        <li class="list-group-item position-static rounded-0 text-white fw-bolder bg-primary border-primary" aria-current="true">Personal Information</li>
                        <li class="list-group-item position-static d-flex f-wrap justify-content-between align-items-center">
                            Full Name: 
            ...
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body justify-content-center">
                        <form class="row g-3" id="editProfile" action="/dashboard/avatar"  method="POST" enctype="multipart/form-data">
                            <div class="col-12">
                    ...
                    <div class="modal-body justify-content-center">
                        <form class="row g-3" id="addMedia" action="/dashboard/social"  method="POST">
                                            ...
                                            <div class="row justify-content-between align-items-baseline">
                                                <div class="col-12 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="selectedMedia[]" value="">
                                                ...
                                                <div class="col-12 col-md-8 mb-3" style="display:none;">
                                                    <div class="align-self-center">
                                                        ...
                                                        <input id="socialname-url" type="URL" class="form-control d-inline" style="width: 98%" name="URL" placeholder="...." value="">
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- end for -->
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <button type="submit" class="btn bg-opacity-primary rounded-0 text-white" formaction="/dashboard/social/update">Update</button>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="updatePersonalInformationModal" tabindex="-1" aria-labelledby="updatePersonalInformationModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content rounded-0">
                    <div class="modal-header mt-3">
                        <h6 class="modal-title" id="updatePersonalInformationModalLabel">Update Personal Information</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        <div class="circle-custom-icon bg-primary d-flex justify-content-center align-items-center shadow-sm">
                            <i class="fas fa-pen-alt text-white"></i>
                        </div>
                    ...
                    <div class="modal-body justify-content-center">
                        <form action="/dashboard" method="POST">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="fullname" value="" id="fullname_edit" placeholder="fullname...">
                                </div>
                            </div>
                            <div class="mb-2">
                                <label for="username_edit"></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="username" value="" id="user_edit" placeholder="username...">
                                </div>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="bio" value="" id="bio_edit" placeholder="bio...">
                                </div>
                            </div>
                            <div class="mb-2">
                                <label for="mobile_edit"></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="mobile" value="" id="mobile_edit" placeholder="mobile...">
                                </div>
                            </div>
                            <div class="mb-2">
                                <label for="address_edit"></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="address" value="" id="address_edit" placeholder="address...">
                                </div>
                            </div>
                            <input type="submit" class="btn bg-opacity-primary rounded-0 text-white" value="Save">
                        </form>
