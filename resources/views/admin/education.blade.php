        ...
        <div class="sidebar-menu px-4">
            <div class="profile text-center">
                <div class="position-relative">
                    <img src="../img/dashboard/profile.jpg" alt="" class="p-1 rounded-circle border border-dark border-3" width="120" height="120">
                    <button class="cursor-pointer rounded-circle shadow position-absolute hidden" data-bs-toggle="modal" data-bs-target="#changeProfileModal">
    ...
    <div class="dash-main__content">
        ...
        <div class="page-content my-4 px-5 mx-auto">
            <div class="row">
                <div class="col-12 col-md-8">
                    <div class="row pt-4 px-4 justify-content-evenly">
                        <div class="col-12 col-md-2 mt-2 year_location d-flex flex-column fs-12 text-muted text-uppercase fw-bold">
                        ...
                        <div class="col-12 col-md-9 bg-white p-2 px-4">
                            <span class="h3 text-primary">IT Engineering,</span><small class="fs-5 text-opacity-primary"> Bachelor's degree</small>
                            <p class="py-2">
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    <div class="row pt-4 px-4 justify-content-evenly">
                        <div class="col-12 col-md-2 order-1 mt-2 year_location d-flex flex-column fs-12 text-muted text-uppercase fw-bold">
                            <div class="datetime">2014 - 2019</div>
                            <div class="educational-side w-100">Taiz Univ</div>
                            <div class="location">Yemen</div>
                        </div>
                ...
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body justify-content-center">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="col-sm-10">
                                <input type="url" class="form-control" id="whatsapp_edit" placeholder="whatsapp link...">
                            </div>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="col-sm-10">
                                <input type="url" class="form-control" id="twitter_edit" placeholder="twitter link...">
                            </div>
                        </div>
                        <div class="mb-2">
