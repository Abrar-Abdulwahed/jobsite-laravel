                ...
                <div class="col-lg-8">
                    <div class="row align-items-baseline mb-30">
                        <div class="list-grid-btn float-start w-auto pe-4">
                            <a href="#" class="text-dark mx-1 display-4">
                                <i class="fas fa-th">
                                </i>
                            </a>
                            <a class="active" href="#">
                    ...
                    <div class="row">
                            ...
                            <div class="card border-0 p-4 job-list-view overflow-hidden w-100 shadow mb-30">
                                <div class="p-1 border-0">
                                    <div class="card-custom-avatar d-flex align-items-center">
                                        <img class="img-fluid rounded-circle" src="../imgs/icon/job-list2.png" alt="icon"
                                            width="40">
                                    ...
                                    <div class="d-flex">
                                        <a class="btn btn-primary" href="{{ route('jobDetails') }}">Details
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="card border-0 p-4 job-list-view overflow-hidden w-100 shadow mb-30">
                                <div class="p-1 border-0">
                                    <div class="card-custom-avatar d-flex align-items-center">
                                        <img class="img-fluid rounded-circle" src="../imgs/icon/job-list4.png" alt="icon"
                                            width="40">
                                        <div class="post-head p-2 flex-column">
                                            <h4>
                                    ...
                                    <div class="d-flex">
                                        <a class="btn btn-primary" href="{{ route('jobDetails') }}>Details
                                                 ...
                                                 d-flex justify-content-evenly other-info mt-3">
                                            <li class="location">
                                                <a href="#" class="text-muted">
                                                    <i class="fas fa-map-marker-alt me-2"></i>
                                                    Egypt,
                            ...
                            <div class="col-lg-12 mt-3">
                                <div class="card border-0 p-4 job-list-view overflow-hidden w-100 shadow mb-30">
                                    <div class="p-1 border-0">
                                        <div class="card-custom-avatar d-flex align-items-center">
                                            <img class="img-fluid rounded-circle" src="../imgs/icon/job-list3.png"
                                                alt="icon" width="40">
                                            <div class="post-head p-2 flex-column">
                                                <h4>
                            ...
                            <div class="col-lg-12 mt-3">
                                <div class="card border-0 p-4 job-list-view overflow-hidden w-100 shadow mb-30">
                                    <div class="p-1 border-0">
                                        <div class="card-custom-avatar d-flex align-items-center">
                                            <img class="img-fluid rounded-circle" src="../imgs/icon/job-list1.png"
                                                alt="icon" width="40">
                                            <div class="post-head p-2 flex-column">
                                                <h4>
                                                    <a href="#" class="text-dark fw-bolder">FullStack Developer
