        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" style="border-bottom: 2px solid var(--primary-clr);"
                            aria-current="page" href="{{ route('home') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('findJob') }}">Find a Job</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex">
                    <a href="{{ route('register') }}" class="btn btn-primary me-1">Register</a>
                                ...
                                <div class="footer-form">
                                    <div id="mc_embed_signup">
                                        <form target="_blank"
                                            ...
                                            <input type="email" name="EMAIL" class="bg-white"
                                                id="newsletter-form-email" placeholder="Email Address"
