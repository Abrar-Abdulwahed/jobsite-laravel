                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg"
                            style="background-image: url('imgs/work.jpeg');">
                            <div class="hero__text rounded-2"
                                style="background: rgba(255, 255, 255, 0.747); padding: 5px 20px;">
                        ...
                        <div class="carousel-inner vertical">
                            <div class="carousel-item active">
                                <div class="card border-0 m-1 p-2">
                                    ...
                                    <div class="text-center mt-2 p-3"> <img
                                            src="https://img.icons8.com/color/96/000000/google-logo.png" width="60" /> <span
                                            class="d-block font-weight-bold">UX Designer</span>
                                        <hr> <span>Google Inc</span>
                                        <div class="d-flex flex-row align-items-center justify-content-center"> <i
                                                class="fa fa-map-marker"></i> <small class="ml-1">FA 100, OH,
                                                USA</small> </div>
                                        <div class="d-flex justify-content-between mt-3"> <span>$34,000</span> <button
                            ...
                            <div class="carousel-item">
                                <div class="card border-0 m-1 p-2">
                                    <div class="text-right"> <small>Full Time</small> </div>
                                    <div class="text-center mt-2 p-3"> <img
                                            src="https://img.icons8.com/color/96/000000/behance.png" width="60" /> <span
                                            class="d-block font-weight-bold">UX Designer</span>
                                        <hr> <span>Behance Inc</span>
                                        <div class="d-flex flex-row align-items-center justify-content-center"> <i
                                                class="fa fa-map-marker"></i> <small class="ml-1">FA 130, OH,
                                                USA</small> </div>
                                        <div class="d-flex justify-content-between mt-3"> <span>$30,000</span> <button
                                                class="btn btn-sm btn-outline-dark">Apply Now</button> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card border-0 m-1 p-2">
                                    <div class="text-right"> <small>Full Time</small> </div>
                                    <div class="text-center mt-2 p-3"> <img
                                            src="https://img.icons8.com/officel/80/000000/dribbble.png" width="60" /> <span
                                            class="d-block font-weight-bold">UX Designer</span>
                                        <hr> <span>Dribbble Inc</span>
                                        <div class="d-flex flex-row align-items-center justify-content-center"> <i
                                                class="fa fa-map-marker"></i> <small class="ml-1">FA 280, OH,
                                                USA</small> </div>
                            ...
                            <div class="carousel-item">
                                <div class="card border-0 m-1 p-2">
                                    <div class="text-right"> <small>Full Time</small> </div>
                                    <div class="text-center mt-2 p-3"> <img
                                            src="https://img.icons8.com/fluent/48/000000/instagram-new.png" width="60" />
                                        <span class="d-block font-weight-bold">UX Designer</span>
                                        <hr> <span>Instagram Inc</span>
                                        <div class="d-flex flex-row align-items-center justify-content-center"> <i
                                                class="fa fa-map-marker"></i> <small class="ml-1">FA 104, OH,
                                                USA</small> </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                            <div class="card bg-white border-white border-0">
                                <div class="card-header bg-transparent d-flex align-items-center">
                                    <img class="img-fluid rounded-circle me-2" src="./imgs/icon/job-list1.png" alt="icon"
                                        width="50">
                                    <h4 class="card-title">UX/UI Designer</h4>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                        Temporibus optio architecto eaque.</p>
                                </div>
        ...
        <div class="container">
            <div id="carouselPartner" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#carouselPartner" data-bs-slide-to="0" class="active"
                        aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#carouselPartner" data-bs-slide-to="1"
