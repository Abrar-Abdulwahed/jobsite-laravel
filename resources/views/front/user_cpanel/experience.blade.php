                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 mt-3">
                        <div class="card border-0 pt-4 px-4 mb-30">
                            <div class="card-head d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a role="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                        aria-expanded="true"><i class="fas fa-ellipsis-v"></i></a>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                        style="position: absolute; inset: auto 0px 0px auto; margin: 0px; transform: translate3d(0px, -25.4px, 0px);"
                                        data-popper-placement="top-end">
                                        <li class="p-2">
                                            <a class="dropdown-item editExperienceModalBTN" role="button"
                                                data-bs-toggle="modal" data-bs-target="#editExperienceModal" data-id=""
                                                data-jobTitle="" data-jobCategory="" data-companyName="" data-location=""
                                        ...
                                        <li class="p-2">
                                            <a class="dropdown-item deleteExperienceModalBTN" role="button"
                                                data-bs-toggle="modal" data-bs-target="#deleteExperienceModal" data-id="">
                        ...
                        <div class="modal-body justify-content-center">
                            <form class="row g-3 needs-validation" action="/dashboard/experiences" method="POST">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jobCategory" id="job-category"
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="companyName" id="company-name"
                        ...
                        <div class="modal-body justify-content-center">
                            <form class="row g-3" method="POST" id="editExperienceForm">
                                ...
                                <div class="mb-2">
                                    <label for="job-title"></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jobTitle" id="job-title-edit"
                                            placeholder="Job Title...">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="job-category"></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jobCategory" id="job-category-edit"
                                            placeholder="Job Category...">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="company-name"></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="companyName" id="company-name-edit"
                                            placeholder="Company Name...">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="location"></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="location" id="location-edit"
                                            placeholder="Location...">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="description"></label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" id="description-edit" cols="30" rows="10"
                                            placeholder="Decription..."></textarea>
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="start-date"></label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="startDate" id="start-date-edit"
                                            placeholder="Start Date...">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label for="end-date"></label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="endDate" id="end-date-edit"
                                            placeholder="End Date...">
                                    </div>
                                </div>
                                <input type="submit" class="btn bg-opacity-primary rounded-0 text-white" value="Save">
