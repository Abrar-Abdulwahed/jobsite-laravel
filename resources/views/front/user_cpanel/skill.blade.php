                                ...
                                <div class="progress-header d-flex f-wrap justify-content-between align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                            ...
                                            <li class="p-2">
                                                <a class="dropdown-item editSkillModalBTN" role="button"
                                                    data-bs-toggle="modal" data-bs-target="#editSkillModal" data-id=""
                                                    data-name="" data-range="" data-color="">
                                                    <i class="fas fa-edit" style="color: blue;"></i>
                                                    <span class="d-inline-block"> Edit</span>
                                                </a>
                                            </li>
                                            <li class="p-2">
                                                <a class="dropdown-item deleteSkillModalBTN" role="button"
                                                    data-bs-toggle="modal" data-bs-target="#deleteSkillModal" data-id="">
                    ...
                    <div class="modal-content rounded-0">
                        ...
                        <div class="modal-body justify-content-center">
                            <form class="row g-3 needs-validation" action="/dashboard/skills" method="POST">
                                <div class="col-12">
                                    <input type="text" class="form-control" id="skill" name='name'
                                        placeholder="Skill Name">
                                </div>
                                <div class="col-12">
                                    <label for="skillRange" style="color: #777;">Range</label>
                                    <input type="range" class="form-range" aria-valuenow id="skillRange"
                                        name="percentage">
                                </div>
                                <div class="col-12">
                                    <label for="skillColorPicker" class="form-label">Color picker</label>
                                    <input type="color" class="form-control form-control-color" name="color"
                                        id="skillColorPicker" title="Choose your color">
                                </div>
                    ...
                    <div class="modal-content rounded-0">
                        ...
                        <div class="modal-body justify-content-center">
                            <form class="row g-3 needs-validation" id="editSkillForm" action="" method="POST">
                                <div class="col-12">
                                    <input type="text" class="form-control" id="editSkillName" name='name'
                                        placeholder="Skill Name">
                                </div>
                                <div class="col-12">
                                    <label for="skillRange" style="color: #777;">Range</label>
                                ...
                                <div class="col-12">
                                    <label for="skillColorPicker" class="form-label">Color picker</label>
                                    <input type="color" class="form-control form-control-color" id="editSkillColor"
                                        name="color" id="skillColorPicker" title="Choose your color">
                                </div>
                                <input type="submit" class="btn bg-opacity-primary rounded-0 text-white" value="save">
                            </form>
                        </div>
