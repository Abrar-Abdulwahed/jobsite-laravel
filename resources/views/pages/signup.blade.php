                                ...
                                <div class="d-flex justify-content-between align-items-center pb-2 mb-4">
                                    ...
                                    <ul class="nav nav-tabs rounded-pill py-1 px-2" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button
                                                class="nav-link border-0 py-1 px-2 rounded-pill active"
                                                id="employee-tab"
                                                data-bs-toggle="tab"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button
                                                class="nav-link border-0 py-1 px-2 rounded-pill"
                                                id="hirer-tab"
                                                data-bs-toggle="tab"
                                                data-bs-target="#hirer"
                                                role="tab"
                                                aria-controls="hirer"
                                                aria-selected="false"
                                            >
                                        ...
                                        <form class="form-content text-dark mb-3">
                                            <div class="d-flex mb-3">
                                                ...
                                                <input
                                                    type="text"
                                                    id="username"
                                                    class="form-control me-2 border-0 rounded-pill h-40"
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <select class="form-select me-2 border-0 rounded-pill h-40" aria-label="Default select example">
                                        ...
                                        <ul class="social-links d-flex justify-content-center">
                                            <li>
                                                <a href="#" class="btn text-white" style="background-color: #f16262">
                                                    <i class="fab fa-google" style="font-size: 8px !important;"></i> Login with Google
                                                </a
												>
                                            </li>
                                            <li class="mx-1">
