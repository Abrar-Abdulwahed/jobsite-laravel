							...
							<div class="carousel-inner vertical">
									...
									<div class="card border-0 m-1 p-2">
										...
										<div class="text-center mt-2 p-3">
											...
											>
												...
												<small class="ml-1">FA 100, OH, USA</small>
											</div>
								...
								<div class="carousel-item">
									<div class="card border-0 m-1 p-2">
										...
										<div class="text-center mt-2 p-3">
											<img
												src="https://img.icons8.com/color/96/000000/behance.png"
												width="60"
											/>
											<span class="d-block font-weight-bold">UX Designer</span>
											<hr />
											<span>Behance Inc</span>
											<div
												class="d-flex flex-row align-items-center justify-content-center"
											>
												<i class="fa fa-map-marker"></i>
												<small class="ml-1">FA 130, OH, USA</small>
											</div>
											<div class="d-flex justify-content-between mt-3">
												<span>$30,000</span>
												<button class="btn btn-sm btn-outline-dark">
								...
								<div class="carousel-item">
									<div class="card border-0 m-1 p-2">
										...
										<div class="text-center mt-2 p-3">
											<img
												src="https://img.icons8.com/officel/80/000000/dribbble.png"
												width="60"
											/>
											<span class="d-block font-weight-bold">UX Designer</span>
											<hr />
											<span>Dribbble Inc</span>
											<div
												class="d-flex flex-row align-items-center justify-content-center"
											>
												<i class="fa fa-map-marker"></i>
												<small class="ml-1">FA 280, OH, USA</small>
											</div>
											<div class="d-flex justify-content-between mt-3">
												<span>$24,000</span>
												<button class="btn btn-sm btn-outline-dark">
								...
								<div class="carousel-item">
									<div class="card border-0 m-1 p-2">
										...
										<div class="text-center mt-2 p-3">
											...
											<span class="d-block font-weight-bold">UX Designer</span>
											<hr />
											<span>Instagram Inc</span>
											<div
												class="d-flex flex-row align-items-center justify-content-center"
											>
												<i class="fa fa-map-marker"></i>
												<small class="ml-1">FA 104, OH, USA</small>
											</div>
											<div class="d-flex justify-content-between mt-3">
												<span>$38,000</span>
												<button class="btn btn-sm btn-outline-dark">
						...
						<div class="row">
							<div class="col-sm-12 col-md-6 col-lg-4 mb-3">
								<div class="card bg-white border-white border-0">
									<div
										class="card-img"
										style="background-image: url(./imgs/pink-texture.jpg)"
									></div>
									...
									<div class="card-body">
										...
										<p class="card-text">
											...
											Temporibus optio architecto eaque.
										</p>
									</div>
									<div
							...
							<div class="col-sm-12 col-md-6 col-lg-4 mb-3">
								<div class="card bg-white border-white border-0">
									...
									<div class="card-body">
										<h4 class="card-title">Digital Maker</h4>
										<p class="card-text">
											Lorem, ipsum dolor sit amet consectetur adipisicing elit.
											Temporibus optio architecto eaque.
										</p>
							...
							<div class="col-sm-12 col-md-6 col-lg-4 mb-3">
								<div class="card bg-white border-white border-0">
									...
									>
										<a href="#" class="btn btn-outline-primary">التقديم الآن</a>
										<span class="text-muted fs-12px">300$ - 500$</span>
										<span class="text-muted fs-12px">Part Time</span>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="container">
				...
				>
					<div class="carousel-inner vertical">
						<div class="carousel-item active">
							<div class="d-flex justify-content-around">
								...
								<img
									src="imgs/partners/qatar-foundation.PNG"
									alt=""
									width="100"
								/>
							</div>
						...
						<div class="carousel-item">
							<div class="d-flex justify-content-around">
								...
								<img
									src="imgs/partners/saudi-arabia-communications.PNG"
									alt=""
									width="100"
								/>
					...
					<div class="carousel-indicators">
						<button
							type="button"
							data-bs-target="#carouselPartner"
							data-bs-slide-to="0"
							class="active"
							aria-current="true"
							aria-label="Slide 1"
